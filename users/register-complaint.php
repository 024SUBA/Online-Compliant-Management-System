...
<!--<option value="Customer Service">Customer Service</option>
  ...
  <option value="Delivery and Shipping">Delivery and Shipping</option>
  <option value="Privacy and Data Security">Privacy and Data Security</option>
  <option value="Fraud and Scams">Fraud and Scams</option>
  <option value="Website or App Issues">Website or App Issues</option>
  <option value="Employment or Workplace">Employment or Workplace</option>
  <option value="Regulatory Violations">Regulatory Violations</option>
