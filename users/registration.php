  ...
  <head>
	...
	<div class="nav-collapse collapse navbar-inverse-collapse">
				...
				<ul class="nav pull-right">
					...
					<li><a href="http://localhost/complaint-management-system/Complaint Management System/index.html">
					Home	
					</a></li>	
				</ul>
			</div>
...
echo htmlentities($msg);
    ...
    <script>
        $.backstretch("https://localhost/complaint-management-system/Complaint Management System/pexels-jessica-lewis-creative-593324.jpg", {speed: 500});
    </script>
